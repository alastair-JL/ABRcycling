...
figure(3)
subplot(1,2,1)
plot(Tlist,1+Tlist*0,'LineWidth',2);
hold on
plot(Tlist,(ExitNumbers(:,6)+ExitNumbers(:,7))./(ExitNumbers(1,6)+ExitNumbers(1,7)),'LineWidth',2);
plot(Tlist,(ExitNumbers(:,11))./(ExitNumbers(1,11)),'LineWidth',2);
plot(Tlist,(ExitNumbers(:,12))./(ExitNumbers(1,12)),'LineWidth',2);
...
% 
% 
% plot(Tlist,((ExitNumbers(:,8)))./max(ExitNumbers(:,8)),'LineWidth',2);
% hold on
% plot(Tlist,((ExitNumbers(:,8))./(ExitNumbers(:,6)+ExitNumbers(:,7)))./max(((ExitNumbers(:,8))./(ExitNumbers(:,6)+ExitNumbers(:,7)))),'LineWidth',2);
% plot(Tlist,(((ExitNumbers(:,8))./ExitNumbers(:,11)))./max((((ExitNumbers(:,8))./ExitNumbers(:,11)))),'LineWidth',2);
% plot(Tlist,(((ExitNumbers(:,8))./ExitNumbers(:,12)))./max((((ExitNumbers(:,8))./ExitNumbers(:,12)))),'LineWidth',2);
% plot([tSat,tSat],[0,1.1],'k');
% 
% % plot(Tlist,((ExitNumbers(:,8))./(ExitNumbers(:,6)+ExitNumbers(:,7)))./((ExitNumbers(1,8))./(ExitNumbers(1,6)+ExitNumbers(1,7))),'LineWidth',2);
% % hold on
% % plot(Tlist,(((ExitNumbers(:,8))./ExitNumbers(:,11)))./(((ExitNumbers(1,8))./ExitNumbers(1,11))),'LineWidth',2);
% % plot(Tlist,(((ExitNumbers(:,8))./ExitNumbers(:,12)))./(((ExitNumbers(1,8))./ExitNumbers(1,12))),'LineWidth',2);
% % plot(Tlist,1+0*Tlist,'k');
% legend({'M_{import}','M_{base}','M_{select}','M_{HGT}'})
% 
% xlabel('T')
...
% maxTimes=zeros(length(BetaList),3);
% 
% for(bbb=1:length(BetaList))
%     DoubleStateEquilibrium= (mu+g)./BetaList(bbb);
% [~,indx]=max(((ExitNumbers(:,8)-DoubleStateEquilibrium)));
% maxTimes(bbb,1)=Tlist(indx);
% 
% [~,indx]=max(((ExitNumbers(:,8)-DoubleStateEquilibrium)./(ExitNumbers(:,6)+ExitNumbers(:,7))));
