mu=1/10; %(exit rate)
m= [5,1,1,10]; %entrance rate [S,R_A,R_B,X];
...
CycleTimes=[0.0001,0.1,linspace(0.1,50,80),linspace(60,300,50)];
...
CompletionTime= ceil(250000/(2*CycleTime))*(2*CycleTime);
