...
if(exist('X_Tstar_Bastard','var'))
    oldMaxes=max(X_Tstar_Bastard);
end
...
set(gca, 'ColorOrder', StandardColours,'NextPlot', 'replacechildren');
hold on
plot(Tlist,X365small,'--','lineWidth',2)
xlabel('cycle time, T')
ylabel('X_{365}')
...
set(gca, 'ColorOrder', StandardColours,'NextPlot', 'replacechildren');
hold on
plot(Tlist,X_Tstar_Bastard,'--','lineWidth',2)
xlabel('cycle time, T')
ylabel('X_{T*}')
title('Raw')
hold on
...
if(exist('oldMaxes','var'))
    plot(Tlist,X_Tstar_Bastard./oldMaxes,'--','lineWidth',2)
else
    plot(Tlist,X_Tstar_Bastard./max(X_Tstar_Bastard),'--','lineWidth',2)
end
xlabel('cycle time, T')
ylabel('X_{T*}')
